...
<?php
/*
 * Test user_vprintf() when different hexa formats and non-hexa values are passed to
...
// looping to test user_vprintf() with different hexa formats from the above $format array
