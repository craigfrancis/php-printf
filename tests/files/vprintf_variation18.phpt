...
<?php
/*
 * Test user_vprintf() when different scientific formats and non-scientific values are passed to
...
// looping to test user_vprintf() with different scientific formats from the above $format array
