...
<?php
/*
 * Test user_vprintf() when different float formats and non-float values are passed to
...
// looping to test user_vprintf() with different float formats from the above $format array
