...
export QUERY_STRING=''
export PATH_TRANSLATED='/Volumes/WebServer/Projects/php.fprint/tests/files/printf_64bit.php'
export SCRIPT_FILENAME='/Volumes/WebServer/Projects/php.fprint/tests/files/printf_64bit.php'
