...
--FILE--
<?php
/* Prototype  : string user_vprintf(string format, array args)
 * Description: Output a formatted string
 * Source code: ext/standard/formatted_print.c
*/

/*
 * Test user_vprintf() when different char formats and non-char values are passed to
...
// looping to test user_vprintf() with different char formats from the above $format array
