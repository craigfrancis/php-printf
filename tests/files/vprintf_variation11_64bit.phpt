...
<?php
/*
 * Test user_vprintf() when different octal formats and octal values are passed to
...
// looping to test user_vprintf() with different octal formats from the above $formats array
