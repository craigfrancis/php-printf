...
<?php
/*
 * Test user_vprintf() when different string formats and non-string values are passed to
...
// looping to test user_vprintf() with different string formats from the above $format array
