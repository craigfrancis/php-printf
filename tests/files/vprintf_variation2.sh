...
export QUERY_STRING=''
export PATH_TRANSLATED='/Volumes/WebServer/Projects/php.fprint/tests/files/vprintf_variation2.php'
export SCRIPT_FILENAME='/Volumes/WebServer/Projects/php.fprint/tests/files/vprintf_variation2.php'
